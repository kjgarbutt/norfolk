 ...
 *
 */
public class MainAgent implements Steppable {
    ...
    //////////Attributes ///////////////////////////////////
    private double basemoveRate = 100.0; // The base speed of the agent.
	 ...
	 * 
	 */
    public MainAgent(Norfolk gridlock_Norfolk_COPY)	{
        ...
        int posStart = gridlock_Norfolk_COPY.random.nextInt(gridlock_Norfolk_COPY.roads.getGeometries().numObjs);
        MasonGeometry mg = (MasonGeometry) gridlock_Norfolk_COPY.roads.getGeometries().objs[posStart];
    ...
    private void findNewPath(Norfolk geoTest)    {
    ...
    public void step(SimState state)    {
    	Norfolk campState = (Norfolk) state;
        move(campState);
     ...
     */
    private void move(Norfolk geoTest)    {
